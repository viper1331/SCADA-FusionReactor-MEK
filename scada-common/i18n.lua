...
local FR_EXACT = {
    ...
    -- supplementary FR coverage for configurators and compact labels
    ["About"] = "A propos",
    ...
    ["Analog Input: 0-15 redstone power level input\nAnalog Output: 0-15 scaled redstone power level output"] =
        "Entree analogique : niveau redstone 0-15\nSortie analogique : niveau redstone echelle 0-15",
    ["OFFLINE"] = "HORS LIGNE",
    ["ONLINE"] = "EN LIGNE",
    ["Off"] = "Arret",
    ["front"] = "frontal",
    ...
    ["Cooling configuration for unit"] = "Configuration de refroidissement pour l'unite",
    ["please connect the wired comms modem"] = "connectez le modem de communication cable",
    ["There can only be one of these devices per SCADA network, so it will be assigned as the sole"] =
        "Il ne peut y avoir qu'un seul de ces appareils par reseau SCADA, il sera donc affecte comme unique",
    ["This is the"] = "Ceci est le",
    ...
    -- connectivity and modem labels
    ["Wired"] = "Cable",
    ["Wireless"] = "Sans fil",
    ["WiredModem"] = "ModemCable",
    ["WirelessModem"] = "ModemSansFil",
    ["PreferWireless"] = "PrefererSansFil",
    ["please connect the wired comms modem "] = "connectez le modem de communication cable ",
    ["please connect this device via a wired modem or direct contact and ensure the configuration matches what it connects as"] =
        "connectez cet appareil par modem cable ou contact direct et verifiez que la configuration correspond au peripherique detecte",
    ["(required for Pocket)"] = "(requis pour Pocket)",

    -- terse key/value labels used in summaries
    ["AuthKey"] = "CleAuth",
    ["ConnTimeout"] = "DelaiConnexion",
    ["ColorMode"] = "ModeCouleur",
    ["LogMode"] = "ModeJournal",
    ["LogPath"] = "CheminJournal",
    ["SpeakerVolume"] = "VolumeHautParleur",
    ["FrontPanelTheme"] = "ThemePanneauFrontal",
    ["UnitCount"] = "NombreUnites",
    ["UnitID"] = "IDUnite",
    ["PocketEnabled"] = "PocketActif",
    ["PocketTest"] = "TestPocket",
    ["TankFluidTypes"] = "TypesFluideReservoir",
    ["CoolingConfig"] = "ConfigRefroidissement",
    ["FacilityTankMode"] = "ModeReservoirInstallation",
    ["FacilityTankDefs"] = "DefsReservoirInstallation",
    ["FacilityTankConns"] = "ConnexionsReservoirInstallation",
    ["FacilityTankList"] = "ListeReservoirInstallation",
    ["EmerCoolEnable"] = "RefroidUrgenceActif",
    ["EmerCoolSide"] = "CoteRefroidUrgence",
    ["EmerCoolColor"] = "CouleurRefroidUrgence",
    ["EmerCoolInvert"] = "InvertRefroidUrgence",
    ["FastRamp"] = "RampeRapide",
    ["FastRampConfirmed"] = "RampeRapideConfirmee",
    ["AuxiliaryCoolant"] = "RefroidAuxiliaire",
    ["ExtChargeIdling"] = "RalentiChargeEtendu",
    ["SVR_Channel"] = "Canal_SVR",
    ["PLC_Channel"] = "Canal_PLC",
    ["RTU_Channel"] = "Canal_RTU",
    ["CRD_Channel"] = "Canal_CRD",
    ["PKT_Channel"] = "Canal_PKT",
    ["PLC_Timeout"] = "Delai_PLC",
    ["RTU_Timeout"] = "Delai_RTU",
    ["CRD_Timeout"] = "Delai_CRD",
    ["PKT_Timeout"] = "Delai_PKT",

    -- low-level event strings occasionally surfaced in diagnostics
    ["mouse_click"] = "clic_souris",
    ["mouse_drag"] = "glisser_souris",
    ["mouse_scroll"] = "roulette_souris",
    ["mouse_up"] = "relache_souris",
    ["key_up"] = "touche_haut",
    ["modem_message"] = "message_modem",
    ["terminate"] = "terminer",
    ["paste"] = "coller",
    ["char"] = "caractere",
    ["number"] = "nombre",
    ...
    -- additional long-form guidance variants (spacing/casing variants)
    ["There can only be one of these devices per SCADA network, so it will be assigned as the sole "] =
        "Il ne peut y avoir qu'un seul de ces appareils par reseau SCADA, il sera donc affecte comme unique ",
    ["This is the "] = "Ceci est le ",
    ["connected to facility tank "] = "connecte au reservoir installation ",
    ["You selected the "] = "Vous avez selectionne ",
    ["configurator error:"] = "erreur configurateur :",
    ["go through Configure Gateway and apply settings to set any missing settings and repair any corrupted ones"] =
        "passez par Configurer la passerelle et appliquez les parametres pour definir ceux manquants et reparer ceux corrompus",
    ["Make sure your device is either touching the RTU or connected via wired modems. There should be a wired modem on a side of the RTU then one on the device, connected by a cable. The modem on the device needs to be right clicked to connect it (which will turn its border red), at which point the peripheral name will be shown in the chat."] =
        "Assurez-vous que votre appareil touche le RTU ou qu'il est relie via des modems cables. Il doit y avoir un modem cable sur un cote du RTU et un sur l'appareil, relies par un cable. Le modem de l'appareil doit etre clique droit pour se connecter (bordure rouge), puis le nom du peripherique apparaitra dans le chat.",
    ["Make sure your relay is either touching the RTU gateway or connected via wired modems. There should be a wired modem on a side of the RTU gateway then one on the device, connected by a cable. The modem on the device needs to be right clicked to connect it (which will turn its border red), at which point the peripheral name will be shown in the chat."] =
        "Assurez-vous que votre relais touche la passerelle RTU ou qu'il est relie via des modems cables. Il doit y avoir un modem cable sur un cote de la passerelle RTU et un sur l'appareil, relies par un cable. Le modem de l'appareil doit etre clique droit pour se connecter (bordure rouge), puis le nom du peripherique apparaitra dans le chat.",
}
