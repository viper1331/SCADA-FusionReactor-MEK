...
local i18n = require("scada-common.i18n")
...
-- print
---@param message any
function util.print(message) term.write(i18n.translate_console(tostring(message))) end

-- print line
---@param message any
function util.println(message) print(i18n.translate_console(tostring(message))) end

-- timestamped print
---@param message any
function util.print_ts(message) term.write(os.date(p_time) .. i18n.translate_console(tostring(message))) end

-- timestamped print line
---@param message any
function util.println_ts(message) print(os.date(p_time) .. i18n.translate_console(tostring(message))) end
...
function util.localize(text)
    ...
    return i18n.translate_ui(text)
end

-- localization controls
---@param locale string
function util.set_locale(locale) i18n.set_locale(locale) end
---@nodiscard
---@return string
function util.get_locale() return i18n.get_locale() end
...
function util.strwrap(str, limit)
    ...
    return cc_strings.wrap(util.localize(str), limit)
end
