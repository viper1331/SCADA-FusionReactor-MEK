...
local RTU_DEV_TYPES = {
    "boilerValve", "turbineValve", "dynamicValve", "inductionPort", "reinforcedInductionPort", "spsPort",
    "fusionReactorController", "fusionReactorPort", "solarNeutronActivator", "environmentDetector", "environment_detector"
}
local NEEDS_UNIT = {
    "boilerValve", "turbineValve", "dynamicValve", "fusionReactorController", "fusionReactorPort",
    "solarNeutronActivator", "environmentDetector", "environment_detector"
}
...
function peripherals.create(tool_ctl, main_pane, cfg_sys, peri_cfg, style)
    ...
    local function save_peri_entry()
        ...
        elseif peri_type == "dynamicValve" then
            index = 1
        elseif peri_type == "fusionReactorController" or peri_type == "fusionReactorPort" then
            index = 1
