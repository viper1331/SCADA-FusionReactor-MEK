...
print("Termine !")
white()
print("Tous les fichiers ont ete installes. L'application peut etre lancee avec 'startup' et configuree avec 'configure'.")
lgray()
print("Astuce : vous pouvez utiliser 'ccmsim' pour gerer votre installation hors ligne.")
white()
