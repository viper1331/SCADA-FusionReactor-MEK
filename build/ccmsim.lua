local _translate = function(message) return tostring(message) end
do
...
local function println(message) print(_translate(tostring(message))) end
local function print(message) term.write(_translate(tostring(message))) end
...
local function read_local_manifest()
    ...
    if imfile ~= nil then
        ...
        if ok and type(parsed) == "table" and type(parsed.versions) == "table" and type(parsed.files) == "table" then
            local_ok = true
